...
real one. Probe results are memoized per media URL for ten minutes, so repeated
attempts and `list --probe` do not re-ask the same missing paths; transient CDN
